...
// Fixed-Time Motion
  ...
  #endif
  // Ensure FTM_TRAJECTORY_TYPE has a default when only FTM_CONSTANT_JOLT is enabled
  #if ENABLED(FTM_CONSTANT_JOLT) && DISABLED(FTM_POLYS) && !defined(FTM_TRAJECTORY_TYPE)
    #define FTM_TRAJECTORY_TYPE CONSTANT_JOLT
  #endif
#endif
