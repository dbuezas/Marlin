...
#define STRING_CONFIG_H_AUTHOR "David Buezas" // Who made the changes.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 5.80f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1978f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0532 }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.0753 }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, -16, -1.36 }
...
#define Z_PROBE_FEEDRATE_SLOW (2*60 / 2)
...
// Soft wire hacked:
// Marlin/.pio/libdeps/STM32H723VG_btt/SoftWire/src/SoftWire.cpp replaced with https://gist.github.com/dbuezas/e4a7b8afddcee868a09bf014034fc37d
// u8glib hacked:
// https://github.com/MarlinFirmware/U8glib-HAL/pull/31
// set DELAY to zero in Marlin/.pio/libdeps/STM32H723VG_btt/SlowSoftI2CMaster/SlowSoftI2CMaster.h
