...
#define CUSTOM_MACHINE_NAME "Prusawire"
 ...
 */
#define Z_MIN_PROBE_PIN PC13  // before PC0
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, 25, 2 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define PROBE_ENABLE_DISABLE
  ...
  #define PROBE_ENABLE_PIN PC0   // Override the default pin here
#endif
...
#define NEOPIXEL_LED
  ...
  //#define NEOPIXEL_PIN                EXP1_06_PIN// LED driving pin ggf. auch EXP1_06_PIN
  ...
  #define NEOPIXEL2_SEPARATE //Printhead LEDs 3x Neopixel
  #if ENABLED(NEOPIXEL2_SEPARATE)
    #define NEOPIXEL2_INSERIES
    #define NEOPIXEL2_TYPE         NEO_GRBW
    #define NEOPIXEL2_PIN               PE6
