...
#define HOMING_BUMP_MM      { 6, 6, 4 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 6, 6, 12 }      // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  51.5        // (Hz) The default dominant resonant frequency on the X axis.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      760  // (mm) The length of filament for a complete unload.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   725  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
