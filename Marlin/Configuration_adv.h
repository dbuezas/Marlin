...
#define MAX31865_WIRE_OHMS_0              1.30315f // For 2-wire, set the wire resistances for more accurate readings.
//#define MAX31865_WIRE_OHMS_1              0.0f
//#define MAX31865_WIRE_OHMS_2              0.0f
#define MAX31865_WIRE_OHMS_BED            0.95005f
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  //#define USE_OCR2A_AS_TOP
    ...
    #else
      #define FAST_PWM_FAN_FREQUENCY 20000U
    #endif
  #endif
#endif
 ...
 */
#define E0_AUTO_FAN_PIN PB7 // Fan0 pin
...
#define HOMING_BUMP_MM      { 6, 6, .5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
#define FT_MOTION
  ...
  #define FTM_SMOOTHING                       // Smoothing can reduce artifacts and make steppers quieter
    ...
    #define FTM_MAX_SMOOTHING_TIME      0.02f   // (s) Maximum smoothing time. Higher values consume more RAM.
    ...
    #define FTM_SMOOTHING_TIME_E        0.008f   // (s) Smoothing time for E axis. Prevents noise/skipping from LA by
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define FEEDRATE_CHANGE_BEEP_DURATION   3
  #define FEEDRATE_CHANGE_BEEP_FREQUENCY 15000
#endif
...
#define MAX_CMD_SIZE 255 // like M118 P3 [ESP600]/api/services/tts/cloud_say#{"entity_id":"media_player.vacuum_audio","message":"3d\ print\ ready"}
#define BUFSIZE 16
...
#define FWRETRACT
  ...
  #define RETRACT_RECOVER_FEEDRATE_SWAP 8.0   // (mm/s) Default feedrate for recovering from swap retraction
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      0//120  // (mm) The length of filament for a complete unload.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
                                                  //   Set to 0 for manual unloading.
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   5  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH     0//5  // (mm) Slow length, to allow time to insert material.
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    0//80  // (mm) Load length of filament, from extruder gear to nozzle.
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         0//40  // (mm) Length to extrude after loading.
  ...
  #define FILAMENT_UNLOAD_PURGE_LENGTH        0//20  // (mm) An unretract is done, then this length is purged.
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE      10  // (mm/s) feedrate to purge before unload

  #define PAUSE_PARK_NOZZLE_TIMEOUT           1200 // (seconds) Time limit before the nozzle is turned off for safety.
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define TMC2240_CURRENT_RANGE   2   // :{ 0:'RMS=690mA PEAK=1A', 1:'RMS=1410mA PEAK=2A', 2:'RMS=2120mA PEAK=3A', 3:'RMS=2110mA PEAK=3A' }
    // Slope Control: Lower is more silent. Higher runs cooler.
    #define TMC2240_SLOPE_CONTROL   3   // :{ 0:'100V/µs', 1:'200V/µs', 2:'400V/µs', 3:'800V/µs' }
  #endif
  ...
  #define CHOPPER_TIMING { 1, 2, 4 }   // { toff, hend, hstrt }        // All axes (override below)
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Home Assistant"
  //#define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 User Script Done"
  #define CUSTOM_MENU_MAIN_SCRIPT_AUDIBLE_FEEDBACK
  //#define CUSTOM_MENU_MAIN_SCRIPT_RETURN   // Return to status screen after a script
  //#define CUSTOM_MENU_MAIN_ONLY_IDLE         // Only show custom menu when the machine is idle

  #define MAIN_MENU_ITEM_1_DESC "Turn Off"
  #define MAIN_MENU_ITEM_1_GCODE "M118 [ESP600] /api/services/switch/toggle#{\"entity_id\":\"switch.3d_printer_tuya_plug_5_switch\"}"
  #define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action
  #define MAIN_MENU_ITEM_1_IMMEDIATE        // Skip the queue and execute immediately. Rarely needed.

  #define MAIN_MENU_ITEM_2_DESC "Toggle Room Light"
  #define MAIN_MENU_ITEM_2_GCODE "M118 [ESP600] /api/services/light/toggle#{\"entity_id\":\"light.wintergarten_spots\"}"
