...
#define MAX31865_WIRE_OHMS_0              2.0f // For 2-wire, set the wire resistances for more accurate readings.
//#define MAX31865_WIRE_OHMS_1              0.0f
//#define MAX31865_WIRE_OHMS_2              0.0f
#define MAX31865_WIRE_OHMS_BED            0.9f
...
#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_Y  44        // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.16f       // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Z)
    #define SHAPING_FREQ_Z  21.0        // (Hz) The default dominant resonant frequency on the Z axis.
    #define SHAPING_ZETA_Z  0.03       // Damping ratio of the Z axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
